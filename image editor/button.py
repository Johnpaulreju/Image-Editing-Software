...
#####      Frame 3
        ...
        self.b6.bind("<ButtonRelease>", self.undo_button_released)

    def undo_button_released(self, event):
        messagebox.showinfo("WARNING","This Function is currently not Available")
    def save_as_button_released(self, event):
        if self.winfo_containing(event.x_root, event.y_root) == self.b5:

...
class ImageViewer(Frame):
    ...
    def __init__(self, master=None):
        Frame.__init__(self, master=master, width="800", height="460",borderwidth = 2,highlightbackground="black",highlightthickness=3, relief=RIDGE)
        ...
        self.canvas = Canvas(self, width=710, height=446)
